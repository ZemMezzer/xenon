...
public sealed class SemanticAnalyzerTests
{
    ...
    [InlineData("struct Holder { public int Value; public readonly int* readonly Pointer { get { return &Value; } } }")]
    ...
    [InlineData("struct Holder { public int Value; public int* readonly Pointer { get { return &Value; } } }", "cannot return a mutable capability")]

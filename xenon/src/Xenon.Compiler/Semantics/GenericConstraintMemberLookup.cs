...
internal static class GenericConstraintMemberLookup
{
        ...
        GenericParameterSymbol parameter, TypeFactory types, GenericStructSpecializer? specializer) => type switch
    {
        ...
        FunctionValueTypeSymbol function => types.FunctionValue(
            SubstituteTemplateSelf(function.ReturnType, template, parameter, types, specializer),
            function.ParameterTypes.Select(value =>
                SubstituteTemplateSelf(value, template, parameter, types, specializer))),
        ...
        AtomicTypeSymbol atomic => types.AtomicOf(
            SubstituteTemplateSelf(atomic.ElementType, template, parameter, types, specializer)),
